...
if __name__ == '__main__':
    checkpoint = 'img_fusion/deep_image_matting/BEST_checkpoint.tar'
    # CPU only
    ...
    im_name = r'E:\My_github\qumaishou\img_fusion\test\10002208374_10.jpg'
    bg_name = r'E:\My_github\qumaishou\resource\background\466086514472648626.jpg'

    img, alpha, fg, bg = process_test(im_name, bg_name)

    cv.imwrite('img_fusion/deep_image_matting/images/{}_image.png'.format(i), img)
    cv.imwrite('img_fusion/deep_image_matting/images/{}_alpha.png'.format(i), alpha)
    ...
    cv.imwrite('img_fusion/deep_image_matting/images/{}_trimap.png'.format(i), trimap)
    ...
    cv.imwrite('img_fusion/deep_image_matting/images/{}_compose.png'.format(i), im)
    cv.imwrite('img_fusion/deep_image_matting/images/{}_new_bg.png'.format(i), new_bg)
