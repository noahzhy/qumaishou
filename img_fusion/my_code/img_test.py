...
def generate_trimap(alpha, write_name):
    ...
    cv.imwrite(r"img_fusion\image_matting\data\input\test.png", img)
    cv.imwrite(r"img_fusion\image_matting\data\trimap\test.png", trimap)
...
def load_img():
    random.random()
    img_list = glob.glob(r'img_fusion\test\*')
